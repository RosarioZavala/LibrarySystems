...
protected void doGet (HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
	...
	int inventario = Integer.parseInt(
			request.getParameter("inventarioTXT") == null ? "0" : request.getParameter("inventarioTXT"));
	BigDecimal precioVenta = new BigDecimal(request.getParameter("precioVentaTXT") == null ? "0" : request.getParameter("precioVentaTXT"));
	BigDecimal precioCompra = new BigDecimal(request.getParameter("precioComprasTXT") == null ? "0" : request.getParameter("precioComprasTXT"));
...
//	BigDecimal precioCompra, int inventario, boolean status, InputStream portada
	...
	Libro libroEntity  = new Libro(0, titulo, isbn, descripcion, paginas, precioVenta,precioCompra,inventario,true, null);
